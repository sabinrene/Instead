    ...
    if (data[i]["liveOnline"]==liveOrOnline.toLowerCase()) {
      ...
      $('#SecWrap').append(
        '<div class="PCard">'+
           ...
           '<div class="BoxOne">'+
             '<div>'+
               '<h4> [<span class="Live">' + data[i]["liveOnline"] + '</span>] ' + data[i]["courseTitle"] + ' </h4>'+
            ...
            ' <a id="selectCourses'   + i+     '" href="CourseTemplate.php">'+
            ' <button class="PBtn"> View Course </button>'+
            ' </a>'+

           '</div>'+

           '<div class="BoxTwo">'+
             '<img src="../../Public/images/02-Course/Img-Course/' + data[i]["imageCourse"] + '">'+
           '</div>'+
