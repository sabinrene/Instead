...
<!--
    ...
    <div class="PCard">
        ...
        <div class="BoxOne">
          <div>
            <h4> [<span class="Online">Online</span>] PDMS Course </h4>
            <h5> Start Date: 02 Aug 2020 </h5>
            <p> Online AVEVA PDMS 3D design software delivers maximum productivity and capability
            on all types of plant project, from the smallest upgrade to new build projects of
            unlimited size and complexity.Online PDMS users range from small engineering
            contractors to many of the largest multinational process and power companies.
            A fully interactive, colour shaded 3D plant design environment... </p>
          </div>
        ...
        <div class="BoxTwo">
          <img src="../../Public/images/OnPipePics/Pic3.jpg">
        </div>
...
-->
    ...
    <script src="../../Public/JS/Course/Section.js"></script>
