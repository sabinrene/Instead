<div class="modal" id="modal-signup">
  ...
  <div class="body">
      <input class="userType" type="text" id="AdressAnduserType" >
...
<div class="modal" id="modal-login">
  ...
  <div class="head-modal">
    ...
    <img  id="close-login" src="Public/images/close.png" alt="">
  </div>
  <div class="body">
      <input class="email" type="email" id="emailLogin" name="field2" placeholder="Email *">
      <input class="password" type="password" id="passwordLogin" name="field2" placeholder="Password *">
      <input class="btn btn-signup"  id="read" type="submit" class="save" value="Log In" />
  </div>
